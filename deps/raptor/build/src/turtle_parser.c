...
{
       0,   216,   216,   221,   220,   253,   252,   278,   279,   282,
     283,   286,   298,   312,   322,   323,   326,   327,   328,   361,
     397,   433,   440,   480,   524,   564,   608,   618,   631,   692,
     724,   735,   735,   738,   772,   809,   817,   827,   831,   835,
     842,   849,   853,   857,   861,   865,   878,   890,   913,   936,
     952,   967,   978,   991,  1004,  1021,  1034,  1050,  1064,  1081,
    1085,  1092,  1110,  1164,  1266
};
#endif

#if TURTLE_PARSER_DEBUG || YYERROR_VERBOSE || 1
...
static const char *const yytname[] =
{
  ...
  "\"BASE\"", "\"string literal\"", "\"identifier\"", "\"langtag\"",
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, raptor_parser* rdf_parser, void* yyscanner)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (rdf_parser);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, raptor_parser* rdf_parser, void* yyscanner)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, rdf_parser, yyscanner);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, raptor_parser* rdf_parser, void* yyscanner)
{
